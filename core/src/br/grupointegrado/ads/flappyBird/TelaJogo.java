...
public class TelaJogo extends TelaBase {
    ...
    private boolean jogoInciado = false;
    ...
    /**
     * Recria a tela do jogo com todos
     */
    ...
    private void atualizar(float delta) {
        ...
        passaro.atualizar(delta, !gameOver && jogoInciado);
        ...
        if (pulando && !gameOver && jogoInciado) {
            passaro.pular();
        }
    }
    ...
    private void atualizarInformacoes() {
        ...
        btnPlay.setVisible(!jogoInciado);
